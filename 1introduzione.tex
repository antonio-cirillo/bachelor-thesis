...
Più di recente sono comparsi i database NoSQL (non relazionale), in risposta all'aumento della mole di dati e alla velocità con cui essi vengono prodotti. A differenza dei database relazionali, i database NoSQL non utilizzano un singolo modo per poter rappresentare i dati, ma offrono una varietà di modelli con i quali è possibile rappresentarli e gestirli.
