...
\usepackage{color}
\usepackage[block=ragged,backend=biber,natbib=true,sorting=none]{biblatex}% Use the bibtex backend with the authoryear citation style (which resembles APA)
...
{\Large Informatica}\\
\vfill\vfill
{\Huge Implementazione NoSQL in linguaggio Fly}
\vfill\vfill


{\bf Relatore} \hfill {\bf Candidato}\ \ \\
Prof. Vittorio Scarano \hfill Antonio Cirillo\\
{\bf Correlatore} \hfill {\bf }\hfill {\bf Mat.} 05121 06096\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Supporto ai database NoSQL}
\input{4impl.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Implementazione query distribuite}
\input{5query.tex}
