...
I database a grafo sono un tipologia di database che utilizza nodi e archi per rappresentare e archiviare i dati. Questa modello di rappresentazione permette di ottenere una maggiore velocità nell'associazione di insieme di dati rispetto ai database relazionali. Inoltre, scalano più facilmente a grandi quantità di dati e non richiedono le tipiche e onerose operazioni di unione. \\
